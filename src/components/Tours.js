...
const toursData = [
  ...
  },
  {
    ...
    price: "$199",
    description: "Join us for an exhilarating Mountain Adventure! Hike through stunning landscapes, enjoy breathtaking views, and discover the thrill of outdoor exploration.",
    itinerary: [
